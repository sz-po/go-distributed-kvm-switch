...
type Specification struct {
	...
	WorkingDirectoryPath *string `json:"workingDirectoryPath,omitempty" validate:"omitempty,filepath"`
...
var ErrInvalidWorkingDirectory = fmt.Errorf("working directory not found")
var ErrWorkingDirectoryIsNotDirectory = fmt.Errorf("working directory is not a directory")
